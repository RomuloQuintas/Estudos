...
public class ProdutoTerceirizado extends GerenciadorAbstractClass implements GerenciadorInterface{

    //metodo construtor e tambem o cadastrador de produto
    public ProdutoTerceirizado(String nome, double preco, int quantidade, String fornecedor) {
        this.setNome(nome);
        this.setPreco(preco);
